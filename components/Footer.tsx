        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 sm:gap-4 text-[10px] sm:text-xs">
          ...
          <div className="col-span-2 sm:col-span-1">
            ...
            <div className="flex items-center gap-1">
              ...
              <a href="https://youtube.com/@aytix" target="_blank" rel="noopener noreferrer" className="w-5 h-5 bg-slate-800 rounded flex items-center justify-center hover:bg-red-600 transition-colors">
          ...
          <div>
            ...
            <div className="space-y-0.5">
              ...
              <a href="tel:+998909564222" className="text-slate-400 hover:text-white flex items-center gap-1 transition-colors">
                <svg className="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                +998 90 956 42 22
              </a>
              <a href="tel:+998948679300" className="text-slate-400 hover:text-white flex items-center gap-1 transition-colors">
                <svg className="w-2.5 h-2.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" /></svg>
                +998 94 867 93 00
              </a>
            </div>
