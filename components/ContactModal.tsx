          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 sm:gap-3">
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <span className="font-medium text-xs text-slate-900 dark:text-slate-100 group-hover:text-[#229ED9]">@Ikhtiyor_sb</span>
              </a>

              <a
                href="https://t.me/bek_usarov"
                target="_blank"
                rel="noopener noreferrer"
                className="flex items-center gap-2 p-2 rounded-lg bg-slate-50 dark:bg-slate-700/50 hover:bg-[#229ED9]/10 dark:hover:bg-[#229ED9]/20 border border-slate-200 dark:border-slate-600 hover:border-[#229ED9] transition-all group"
              >
                ...
                <span className="font-medium text-xs text-slate-900 dark:text-slate-100 group-hover:text-[#229ED9]">@bek_usarov</span>
              </a>
            </div>
            ...
            <div className="space-y-1.5">
              ...
              >
                ...
                <span className="font-medium text-xs text-slate-900 dark:text-slate-100 group-hover:text-green-600">+998 94 867 93 00</span>
              </a>

              <a
                href="tel:+998909564222"
                className="flex items-center gap-2 p-2 rounded-lg bg-slate-50 dark:bg-slate-700/50 hover:bg-green-50 dark:hover:bg-green-900/20 border border-slate-200 dark:border-slate-600 hover:border-green-500 transition-all group"
              >
                <div className="w-7 h-7 rounded-full bg-green-500 flex items-center justify-center text-white">
                  <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="font-medium text-xs text-slate-900 dark:text-slate-100 group-hover:text-green-600">+998 90 956 42 22</span>
              </a>
            </div>
          </div>
        </div>
