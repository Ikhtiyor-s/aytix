...
export default function ProjectDetailPage() {
  ...
  // Description uzunligini tekshirish - 300 belgidan ko'p bo'lsa tugma ko'rsatish
  const descriptionText = project ? (language.code === 'ru' && project.description_ru ? project.description_ru : language.code === 'en' && project.description_en ? project.description_en : project.description_uz || '') : ''
